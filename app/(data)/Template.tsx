export default [
  {
    ...
    aiPrompt:
      "Answer the following question based on the best available knowledge and make your answers as detailed as you can:",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate a detailed blog post in Rich Text Editor format based on the given niche & outline, with appropriate headings, subheadings, and paragraphs.",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate a Facebook post with appropriate call-to-action based on the given idea and audience.",
  ...
  },
  {
    ...
    aiPrompt:
      "Give me 5 engaging Facebook content ideas based on the provided niche and target audience.",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate a creative and engaging Facebook bio based on the given personality traits and interests.",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate 20 highly relevant Instagram hashtags based on the provided content description.",
  ...
  },
  {
    ...
    aiPrompt:
      "Give me 5 creative Instagram video content ideas based on the provided niche and theme.",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate a creative and captivating Instagram bio based on the given theme, niche, and personality traits.",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate a list of 10 high-ranking keywords based on the provided niche and audience. Include search volume and keyword difficulty. Include sub-keywords too",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate a professional LinkedIn bio based on the given profession, skills, and achievements. Do not exceeded maximum character length of 220",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate a professional and engaging LinkedIn post based on the provided topic and audience. Include relevant insights, call-to-actions, and hashtags.",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate 5 engaging LinkedIn content ideas based on the provided profession and target audience.",
  ...
  },
  {
    ...
    aiPrompt:
      "Check the provided content for any plagiarized sections and provide a plagiarism report.",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate a detailed and persuasive product description based on the given product features and target audience.",
...

  {
    ...
    aiPrompt:
      "Generate 20 inspiring and unique quotes related to the given theme or keyword.",
    slug: "generate-quote",
    form: [
      {
  ...
  },
  {
    ...
    aiPrompt:
      "Give me 5 creative TikTok video content ideas based on the provided niche and trend.",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate 20 trending TikTok hashtags based on the provided video description.",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate a short and engaging X(Twitter) bio based on the given profession, interests, and personality traits.",
  ...
  },
  {
    ...
    aiPrompt:
      "Create a detailed X(Twitter) thread based on the provided topic and key points. Ensure each tweet is concise, engaging, and includes relevant hashtags.",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate a YouTube video script based on the given niche and outline, including an engaging intro and outro.",
  ...
  },
  {
    ...
    aiPrompt:
      "Generate optimized YouTube titles, descriptions, and tags based on the given video content and keywords.",
