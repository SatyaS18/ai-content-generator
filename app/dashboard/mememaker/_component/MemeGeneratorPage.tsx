...
const MemeGenerator: React.FC = () => {
  ...
  return (
    <div className="container mx-auto py-8 px-2 ">
      <h1 className="lg:text-4xl text-3xl font-bold text-center mb-8 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-600">
      ...
      <div className="text-center mb-8 lg:p-10 p-3 backdrop-blur-md bg-white/70 border border-purple-600 shadow-md rounded-lg">
        <h2 className="lg:text-2xl text-xl text-gray-600 mb-4">
