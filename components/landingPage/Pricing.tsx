...
const Pricing = () => {
  ...
  const plans = [
    {
      ...
      features: ["10,000 credits", "Basic templates", "Community support"],
      isFree: true,
    },
    {
      name: "Premium",
  ...
  return (
    <section
      id="pricing"
      className="bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 py-16"
    >
      <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-10">
        <div className="mb-12 text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Select the best plan that fits your needs. Enjoy basic features for
            free or upgrade for premium features.
          </p>
        </div>
