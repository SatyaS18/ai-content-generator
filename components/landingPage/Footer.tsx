    ...
    <footer id="contact" className="bg-gray-900 text-gray-300 py-10">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        <div className="flex flex-wrap justify-between items-center">
          ...
          <div className="w-full sm:w-1/3 mb-6 sm:mb-0">
            ...
            <p className="text-gray-400">
              Empowering your digital journey with cutting-edge content creation
              solutions.
            </p>
          </div>
          ...
          <div className="w-full sm:w-1/3">
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                <LucidePhone className="mr-2 text-purple-400" />
                <a href="tel:+919968911572">+91 9968911572</a>
              </li>
              <li className="flex items-center">
                <LucideMail className="mr-2 text-purple-400" />
                <a href="mailto:postit.assist@gmail.com ">
                  satyakantsahu18@gmail.com
                </a>
              </li>
              <li className="flex items-center">
                <LucideHome className="mr-2 text-purple-400" /> ABV IIITM
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 flex justify-between items-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} ForgeCraft All Rights Reserved.
          </p>
